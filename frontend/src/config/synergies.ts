...
export const ELEMENTAL_SYNERGIES: ElementalSynergyDef[] = [
  ...
  },
  {
    ...
    type: 'elemental',
    icon: 'game-icons:cliff-crossing',
    color: '#a08060',
    tier: 'silver',
...
export const LORE_BONDS: LoreBondDef[] = [
  ...
  },
  {
    ...
    type: 'lore_bond',
    icon: 'game-icons:bomb-explosion',
    color: '#e0a020',
    tier: 'silver',
    effects: [{ type: 'dps', multiplier: 1.12 }] as SynergyEffect[],
    pair: ['Ziggs', 'Jinx'],
