...
export const MISSIONS: MissionDef[] = [
  ...
  },
  {
    ...
    chapter: 'wakingOrbit',
    name: 'Chart a Course',
    blurb: 'Three stars wait on the arms. Bard drifts until one is chosen.',
    objective: 'Set course for {n} star in the Galaxy tab',
    icon: 'game-icons:compass',
    metric: 'coursesCharted',
    target: 1,
    unit: 'course',
  ...
  },
  {
    ...
    chapter: 'beyondUniverse',
    name: 'The Long Roads',
    blurb: 'A freed spiral is an address. Send someone to it.',
