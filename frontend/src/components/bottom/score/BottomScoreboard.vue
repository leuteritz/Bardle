...
<template>
  <div ref="rootRef" class="scoreboard" :style="fitVars">
    ...
    <div
      ...
      v-tip="hasLiveStatus ? 'Open Battle Stats' : undefined"
    ...
    <div class="sb-stats sb-stats--right">
      ...
      <div
        ...
        v-tip="cellTitle(`${RANK_CELL.label} · ${rankFullLabel}`)"
        @click="openBattleTab"
        @keydown.enter="openBattleTab"
        @keydown.space.prevent="openBattleTab"
      >
      ...
      <div
        ...
        v-tip="cellTitle(WIN_LOSS_CELL.label)"
        @click="openBattleTab"
        @keydown.enter="openBattleTab"
        @keydown.space.prevent="openBattleTab"
      >
