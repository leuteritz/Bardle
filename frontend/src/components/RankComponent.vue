<template>
  ...
  >
    ...
    <div class="absolute inset-0 opacity-20">
      ...
      ></div>
      <div
        class="absolute w-20 h-20 bg-violet-500 rounded-full top-4 right-4 mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"
      ></div>
      <div
    ...
    >
      ...
      <div
        class="absolute top-0 right-0 w-24 h-24 translate-x-6 -translate-y-6 rounded-full bg-gradient-to-br from-blue-400/20 to-transparent"
      ></div>
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="relative">
          <!-- Outer Glow Ring -->
          <div
            class="absolute transition-opacity duration-300 rounded-full -inset-2 bg-gradient-to-r from-blue-400 to-violet-500 opacity-30 animate-pulse group-hover:opacity-50"
          ></div>
        ...
        <div class="flex flex-col flex-1">
          ...
          <div class="flex items-center mb-2 space-x-2">
            <h3
              class="text-2xl font-black text-transparent bg-gradient-to-r from-blue-300 to-violet-300 bg-clip-text"
            >
              {{ battleStore.currentRank.tier }} {{ battleStore.currentRank.division }}
            </h3>
            <div
              class="px-2 py-1 border rounded-full bg-blue-500/20 border-blue-400/30 backdrop-blur-sm"
            >
              <span class="text-xs font-medium text-blue-300">Current Rank</span>
            </div>
          </div>
          ...
          <div class="flex items-center mb-3 space-x-3">
            ...
            <!-- LP to next rank -->
            <div v-if="getLPToNext() !== null" class="text-xs text-blue-300">
          ...
          <div v-if="!isMaxRank()" class="space-y-2">
            ...
            >
              <div
                class="h-2 transition-all duration-500 rounded-full shadow-sm bg-gradient-to-r from-blue-400 to-violet-500"
                :style="{
                  width: `${getLPProgress()}%`,
          ...
          <div v-else class="space-y-2">
            <div class="flex justify-center">
              <div
                class="px-3 py-1 border rounded-full bg-gradient-to-r from-blue-400 to-violet-500 border-blue-400/50 backdrop-blur-sm"
              >
                <span
                  class="text-xs font-bold text-transparent bg-gradient-to-r from-white to-blue-100 bg-clip-text"
          ...
          <div class="flex items-center justify-between pt-3 mt-3 border-t border-white/20">
            <div class="text-center">
              ...
              <div class="text-xs text-blue-400">Tier</div>
            </div>
            <div class="text-center">
              <div
                class="text-sm font-bold text-transparent bg-gradient-to-r from-blue-300 to-violet-300 bg-clip-text"
              ...
              <div class="text-xs text-blue-400">Top Players</div>
            </div>
            <div class="text-center">
              <div class="text-sm font-bold" :class="getStatusColor()">
                {{ getStatus() }}
              </div>
              <div class="text-xs text-blue-400">Status</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        class="flex items-center justify-between p-3 mt-4 transition-all duration-200 border rounded-lg cursor-pointer bg-gradient-to-r from-blue-500/20 to-violet-500/20 border-blue-400/30 backdrop-blur-sm hover:from-blue-500/30 hover:to-violet-500/30 hover:border-blue-400/50"
      >
        <div class="flex items-center space-x-2">
          ...
          <div
            class="px-2 py-1 text-xs font-medium text-blue-300 border rounded-full bg-blue-500/20 border-blue-400/30"
          >
        ...
        <div
          class="flex items-center justify-center w-8 h-8 transition-transform duration-300 border rounded-full bg-blue-500/20 hover:bg-blue-500/30 border-blue-400/30"
    ...
    >
      <div
        class="p-4 border shadow-xl bg-gradient-to-br from-slate-800 via-blue-950 to-slate-950 rounded-xl border-blue-400/30 backdrop-blur-lg"
      >
        <!-- Main Battle Stats (gleiche Grid) -->
        <div class="grid grid-cols-3 gap-4 mb-3">
          <!-- Total Battles -->
          <div
            class="p-2 text-center transition-all duration-200 border rounded-lg bg-blue-500/20 border-blue-400/30 hover:bg-blue-500/30 backdrop-blur-sm"
          >
            <div
              class="text-lg font-black text-transparent bg-gradient-to-r from-blue-300 to-violet-300 bg-clip-text"
            >
              {{ battleStore.totalBattles }}
            </div>
            <div class="text-xs text-blue-400">Total Battles</div>
          </div>
          ...
          >
            ...
            <div class="text-xs text-blue-400">Victories</div>
          </div>
          ...
          >
            ...
            <div class="text-xs text-blue-400">Defeats</div>
          </div>
        </div>

        <!-- Win Rate and Additional Stats (gleiche Größen) -->
        <div class="flex items-center justify-between pt-2 border-t border-blue-400/20">
          <div class="text-center">
            <div class="text-sm font-bold" :class="getWinRateColor()">{{ getWinRate() }}%</div>
            <div class="text-xs text-blue-400">Win Rate</div>
          </div>
          ...
          <div class="text-center">
            ...
            <div class="text-xs text-blue-400">Win Streak</div>
          </div>

          <div class="text-center">
            <div class="text-sm font-bold" :class="getBattleRankColor()">{{ getBattleRank() }}</div>
            <div class="text-xs text-blue-400">Battle Rank</div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3 mt-4">
          ...
          >
            ...
            <div class="text-xs text-blue-400">Avg. Battle Time</div>
          </div>
          <div
          ...
          >
            ...
            <div class="text-xs text-blue-400">Best Streak</div>
          </div>
        </div>
      </div>
    </div>
